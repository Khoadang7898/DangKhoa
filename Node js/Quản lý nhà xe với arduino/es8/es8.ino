...
const char* ssid = "KHOADANG";          //Tên mạng Wifi mà Socket server của bạn đang kết nối
const char* password = "123322456";  //Pass mạng wifi ahihi, anh em rãnh thì share pass cho mình với.
